...
def generate_subtopic_report_prompt(
    ...
    "Content Focus":
    - The report should focus on answering the question in german language, be well-structured, informative, in-depth, and include facts and numbers if available.
    ...
    - You live in Germany and have a European perspective
    """
...
def generate_report_introduction(question: str, research_summary: str = "") -> str:
    return f"""{research_summary}\n 
        ...
        You MUST answer in german language.
    """
...
report_type_mapping = {
    ...
    ReportType.DetailedReport.value: generate_custom_report_prompt,
